...
(test "numbers: operation expt"
      (lambda (t)
        ...
        (t.is (expt -2 10+10i) 1.8537873553889387e-11+1.4042516359189593e-11i)
        (t.is (expt 1/2 10+10i) 7.784371261899293e-4-5.896693624188176e-4i)
        (t.is (expt -1/2 10+10i) 1.7679093889130928e-17-1.3391987189473645e-17i)
        (t.is (expt 0.5 10+10i) 7.784371261899293e-4-5.896693624188176e-4i)
        (t.is (expt -0.5 10+10i) 1.7679093889130928e-17-1.3391987189473645e-17i)))
