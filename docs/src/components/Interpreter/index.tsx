...
export default function Interpreter(): JSX.Element {
  ...
  useScripts(!globalThis.jQuery && [
    ...
    'https://cdn.jsdelivr.net/combine/gh/jcubic/jquery.terminal@eba98ad9e2/js/jquery.terminal.min.js,npm/js-polyfills/keyboard.js,npm/prismjs/prism.js,npm/jquery.terminal@latest/js/prism.js,npm/prismjs/components/prism-scheme.min.js',
  ...
  return (
    <>
      <Head>
        ...
        <link href="https://cdn.jsdelivr.net/gh/jcubic/jquery.terminal@eba98ad9e2/lib/css/terminal.css"
              rel="stylesheet"/>
        {isStatic && <script src="https://cdn.jsdelivr.net/npm/jquery" />}
        {isStatic && <script src="https://cdn.jsdelivr.net/combine/gh/jcubic/jquery.terminal@eba98ad9e2/js/jquery.terminal.min.js,npm/js-polyfills/keyboard.js,npm/prismjs/prism.js,npm/jquery.terminal@latest/js/prism.js,npm/prismjs/components/prism-scheme.min.js" />}
