...
[![travis](https://travis-ci.org/jcubic/jquery.terminal.svg?branch={{BRANCH}})](https://travis-ci.org/jcubic/jquery.terminal)
[![Coverage Status](https://coveralls.io/repos/github/jcubic/lips/badge.svg?branch={{BRANCH}})](https://coveralls.io/github/jcubic/lips?branch={{BRANCH}})
