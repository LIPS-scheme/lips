 ...
 *
 * build: Thu, 16 Apr 2020 10:33:15 +0000
 */
(function () {
	'use strict';
	...
	(function (root, factory) {
	  ...
	  function extract_patterns(pattern, code) {
	    ...
	    function traverse(pattern, code) {
	      ...
	      if (pattern instanceof LSymbol) {
	        var name = pattern.valueOf();
	        bindings[name] = code;
	        return true;
	      }

	      if (pattern instanceof Pair && code instanceof Pair) {
	        if (traverse(pattern.car, code.car) && traverse(pattern.cdr, code.cdr)) {
	          return true;
	        }
	      } else if (pattern === nil && code === nil) {
	        return true;
	      } else if (pattern.car instanceof Pair && LSymbol.is(pattern.car.car, '...') && code === nil) {
	        bindings['...'] = nil;
	        return true;
	      } else {
	        return false;
	  ...
	  */
	  ...
	  function transform_syntax(bindings, expr, scope, lex_scope, names) {
	    ...
	    function traverse(expr) {
	      if (expr instanceof Pair) {
	        ...
	        if (expr.cdr instanceof Pair && LSymbol.is(expr.cdr.car, '...') && bindings['...']) {
	          expr.cdr = bindings['...'];
	        } else if (expr.cdr instanceof LSymbol) {
	          var _value = transform(expr.cdr);
	  ...
	  var global_env = new Environment({
	    ...
	    // ------------------------------------------------------------------
	    pluck: doc(function () {
	      for (var _len22 = arguments.length, keys = new Array(_len22), _key22 = 0; _key22 < _len22; _key22++) {
	        keys[_key22] = arguments[_key22];
	      }
	    ...
	    reduce: doc(fold('reduce', function (reduce, fn, init) {
	      ...
	      for (var _len23 = arguments.length, lists = new Array(_len23 > 3 ? _len23 - 3 : 0), _key24 = 3; _key24 < _len23; _key24++) {
	    ...
	    '->': doc(function (obj, name) {
	      for (var _len31 = arguments.length, args = new Array(_len31 > 2 ? _len31 - 2 : 0), _key32 = 2; _key32 < _len31; _key32++) {
	  ...
	  var lips = {
	    version: 'DEV',
	    banner: banner,
	    date: 'Thu, 16 Apr 2020 10:33:15 +0000',
	    exec: exec,
	    parse: parse,
	    tokenize: tokenize,
	    evaluate: evaluate,
