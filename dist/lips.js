...
var lib = (function () {
  ...
  Util.coerceOutputStream = function (output, size) {
    ...
    if (output) {
      if (_typeof(output) === 'object' && 'writeByte' in output) {
        return r;
        /* leave output alone */
  ...
  Util.compressFileHelper = function (magic, guts, suppressFinalByte) {
    return function (inStream, outStream, props) {
      ...
      outStream = o.stream; // write the magic number to identify this file type
  ...
  Util.decompressFileHelper = function (magic, guts) {
    return function (inStream, outStream) {
      inStream = Util.coerceInputStream(inStream); // read the magic number to confirm this file type
      // (it better be ASCII, we're not doing utf-8 conversion)
      ...
      outStream = o.stream; // call the guts to do the real decompression
  ...
  Lzjb.compressFile = Util$1.compressFileHelper(Lzjb.MAGIC, function (inStream, outStream, fileSize, props) {
    var cpy,
        mlen,
        offset,
        hash,
    ...
    lempel = Util$1.makeU16Buffer(LEMPEL_SIZE * EXPAND);
    var window = Util$1.makeU8Buffer(OFFSET_MASK + 1);
    var windowpos = 0;
    ...
    var outwindow = Util$1.makeU8Buffer(17);
    var outpos = 0;

    var dumpout = function dumpout() {
      var i;
    ...
    while (true) {
      ...
      for (j = 0; j < EXPAND; j++) {
        ...
        var w3 = window[cpy + 2 & OFFSET_MASK]; // if offset is small, we might not have copied the tentative
      ...
      lempel[hp] = windowpos; // did we find any matches?
      ...
      if (matchpossibility.length === 0) {
        ...
        unget(c4);
        outwindow[outpos++] = mlen - MATCH_MIN << NBBY - MATCH_BITS | last >> NBBY;
  ...
  Lzjb.decompressFile = Util$1.decompressFileHelper(Lzjb.MAGIC, function (inStream, outStream, outSize) {
    var cpy,
        copymap,
        mlen,
        offset,
  ...
  */
  ...
  function _node_specific() {
    _node_specific = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee20() {
      var _yield$import, createRequire, path, nodeRequire, moduleURL, __dirname, __filename;
        ...
        while (1) {
          switch (_context21.prev = _context21.next) {
            ...
            case 9:
              ...
              nodeRequire = createRequire((document.currentScript && document.currentScript.src || new URL('lips.js', document.baseURI).href));
              global_env.set('global', global);
              global_env.set('self', global);
              global_env.set('window', undefined);
              moduleURL = new URL((document.currentScript && document.currentScript.src || new URL('lips.js', document.baseURI).href));
  ...
  function exec_collect(collect_callback) {
    return /*#__PURE__*/function () {
      ...
      function exec_lambda(_x15, _x16, _x17) {
  ...
  var banner = function () {
    ...
    // obviously 'Mon, 25 Oct 2021 21:01:31 +0000' == '{{' + 'DATE}}'; can be removed
    // but disablig Tree-shaking is adding lot of not used code so we use this
    // hack instead
    var date = LString('Mon, 25 Oct 2021 21:01:31 +0000').valueOf();
  ...
  var lips = {
    version: 'DEV',
    banner: banner,
    date: 'Mon, 25 Oct 2021 21:01:31 +0000',
    exec: exec,
