 ...
 *
 * build: Thu, 20 May 2021 10:17:38 +0000
 */
(function () {
  'use strict';
  ...
  (function (root, factory) {
    ...
    */
    ...
    function _uniterate_async() {
      _uniterate_async = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee19(object) {
    ...
    */
      ...
      for (var i = 1; i < tokens.length; ++i) {
        ...
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            var _step7$value = slicedToArray(_step7.value, 3),
    ...
    function macro_expand(single) {
      return /*#__PURE__*/function () {
        var _ref20 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(code, args) {
              ...
              switch (_context12.prev = _context12.next) {
                case 0:
                  _traverse = function _traverse3() {
                    _traverse = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11(node, n, env) {
                  ...
                  _expand_let_binding = function _expand_let_binding3() {
                    _expand_let_binding = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(node, n) {
                      var pair;
                  ...
                  let_binding = function _let_binding(node) {
                    return [].concat(toConsumableArray(bindings), toConsumableArray(node.to_array(false).map(function (node) {
                      if (node instanceof Pair) {
                  ...
                  proc_bindings = function _proc_bindings(node) {
                    ...
                    return [].concat(toConsumableArray(bindings), names);
                  };
    ...
    function InputPort(read) {
      ...
      this._read = read;
      this._with_parser = this._with_init_parser.bind(this, /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13() {
        var line;
    ...
    InputPort.prototype._with_init_parser = function (make_parser, fn) {
      var self = this;
      return /*#__PURE__*/function () {
        var _ref25 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
          var parser,
              _len16,
              args,
              _key16,
    ...
    function OutputByteVectorPort() {
      ...
      this.write = function (x) {
        ...
        if (LNumber.isNumber(x)) {
          ...
          (_this$_buffer = this._buffer).push.apply(_this$_buffer, toConsumableArray(Array.from(x)));
        }
      };
    ...
    var global_env = new Environment({
      ...
      read: doc('read', /*#__PURE__*/function () {
        var _read2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15() {
          var arg,
      ...
      'do': doc(new Macro('do', /*#__PURE__*/function () {
        var _ref29 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee17(code, _ref30) {
    ...
    function resolve_promises(arg) {
      ...
      function _promise() {
        _promise = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee18(node) {
          var pair;
    ...
    function _exec() {
      _exec = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee20(arg, env, dynamic_scope) {
    ...
    var banner = function () {
      ...
      // obviously 'Thu, 20 May 2021 10:17:38 +0000' == '{{' + 'DATE}}'; can be removed
      // but disablig Tree-shaking is adding lot of not used code so we use this
      // hack instead
      var date = LString('Thu, 20 May 2021 10:17:38 +0000').valueOf();
    ...
    var lips = {
      version: 'DEV',
      banner: banner,
      date: 'Thu, 20 May 2021 10:17:38 +0000',
      exec: exec,
