 ...
 *
 * build: Fri, 16 Apr 2021 21:47:32 +0000
 */
(function () {
  'use strict';
  ...
  (function (root, factory) {
    ...
    */
    ...
    InputPort.prototype._with_init_parser = function (make_parser, fn) {
      var self = this;
      return /*#__PURE__*/function () {
        var _ref25 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13() {
          var parser,
              _len16,
              args,
              _key16,
    ...
    var global_env = new Environment({
      ...
      'do': doc(new Macro('do', /*#__PURE__*/function () {
        var _ref29 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16(code, _ref30) {
    ...
    var banner = function () {
      ...
      // obviously 'Fri, 16 Apr 2021 21:47:32 +0000' == '{{' + 'DATE}}'; can be removed
      // but disablig Tree-shaking is adding lot of not used code so we use this
      // hack instead
      var date = LString('Fri, 16 Apr 2021 21:47:32 +0000').valueOf();
    ...
    var lips = {
      version: 'DEV',
      banner: banner,
      date: 'Fri, 16 Apr 2021 21:47:32 +0000',
      exec: exec,
