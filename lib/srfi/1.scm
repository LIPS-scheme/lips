...
;; source: https://www.reddit.com/r/scheme/comments/p8ovr7/how_to_define_letoptionals_macro_from_srfi1/
(define-syntax let-optionals
  (syntax-rules ()
    ((_ expr ((v d) ...) . body)
     (let-optionals/expand () (v ...) (d ...) () f expr body))))

(define-syntax let-optionals/expand
  (syntax-rules ()
    ((_ (vt ...) () _ (cl ...) f expr body)
     (letrec ((f (case-lambda cl ... ((vt ...) . body))))
       (apply f expr)))
    ((_ (vt ...) (vrf . vr*) (df . dr*) (cl ...) f . rest)
     (let-optionals/expand (vt ... vrf) vr* dr* (cl ... ((vt ...) (f vt ... df))) f . rest))))
