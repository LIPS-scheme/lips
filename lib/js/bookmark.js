javascript:(function(next) {
    ...
    var jsdevlr = 'https://cdn.jsdelivr.net';
    [
        `${jsdevlr}/gh/jcubic/jquery.terminal@devel/css/jquery.terminal.min.css`,
        `${jsdevlr}/${LIPS}/lib/css/terminal.css`,
        `${jsdevlr}/npm/terminal-prism/css/prism-coy.css`
