javascript:(function(next) {
    ...
    window.addEventListener('securitypolicyviolation', function handler(event) {
        if (event.blockedURI === 'https://cdn.jsdelivr.net/npm/jquery') {
            clearTimeout(timer);
            alert('[WARN]: This bookmark will not run on this page becase of ' +
    ...
    [
        'https://cdn.jsdelivr.net/gh/jcubic/jquery.terminal@devel/css/jquery.terminal.min.css',
        `https://cdn.jsdelivr.net/${LIPS}/lib/css/terminal.css`,
        'https://cdn.jsdelivr.net/npm/terminal-prism/css/prism-coy.css'
    ...
    if (typeof $.terminal !== 'undefined') {
        ...
        var scripts = [
            ...
            [
                'https://cdn.jsdelivr.net/combine/gh/jcubic/jquery.terminal@3c8166de596b2e4ad539da5f0e1f8a48a937a2bc/js/jquery.terminal.min.js',
        ...
        (function recur() {
            ...
            if (!script) {
                if (window.lips) {
                    ...
                    var url = `https://cdn.jsdelivr.net/${LIPS}/dist/lips.min.js`;
                    $.getScript(url, init);
                }
